...
dict_new_qres = {
    'New_FT': QreFreeText(name='New_FT', label='New_FT. Testing', data_fields=['New_FT'], index=999999),
    'New_NUM': QreNumeric(name='New_NUM', label='New_NUM. Testing', data_fields=['New_NUM'], index=999999),
    'New_SA_Scale': QreSingleAnswer(
    ...
    'New_SA_Others_Exclusive': QreSingleAnswer(
...
mgr.add_qres(qres=dict_new_qres)
